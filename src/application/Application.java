...
public class Application extends JPanel {
	...
	public Application() 
	{
		...
		Worker e = new Worker("Erin", 0, "marketSales", 800, 1300, 1900);
		Worker f = new Worker("Fred", 500, "UPSman", 800, 1300, 1900);
		Worker g = new Worker("Greg", 10, "cashier", 800, 1100, 1700);
		Worker h = new Worker("Henry", 500, "host", 800, 1100, 1700);
		Worker i = new Worker("Iris", 50, "cook", 800, 1100, 1700);
		Worker j = new Worker("Jackie", 500, "waiter", 800, 1100, 1700);
		Worker k = new Worker("Kate", 20, "altWaiter", 800, 1100, 1700);
		Worker l = new Worker("Lauren", 100, "waiter", 800, 1100, 1700);
