...
public class WaiterAgent extends Agent implements Waiter{
	 ...
	 * Messages
	 */
	public void msgPleaseSeatCustomer(int tableNumber, CustomerAgent customer, int xHome, int yHome) {
	...
	public void msgHeresMyOrder(CustomerAgent customer, String choice) {
		for (myCustomer myCust : myCustomers) {
			if (myCust.customer == customer) {
	...
	public void msgIWantMyCheck(CustomerAgent cust) {
		for (myCustomer myCust : myCustomers) {
