...
public class HostAgent extends Agent {
	 ...
	 *	Messages
	 */
	public void msgIWantFood(CustomerAgent cust, int xHome, int yHome) {
	...
	public void msgStaying(CustomerAgent cust, int xHome, int yHome) {
	...
	public void msgLeavingTable(CustomerAgent cust, WaiterAgent waiter) {
	...
	public void msgMayIGoOnBreak(WaiterAgent waiter) {
	...
	private void assignCustomer(myCustomer MC, Table table, WaiterAgent waiter) {
	...
	private void informCustomerRestaurantFull(CustomerAgent customer) {
	...
	public void addCustomerToWaiter(WaiterAgent waiter) {
		for (myWaiter MW: waiters) {
			if (MW.waiter == waiter)
				MW.totalCustomers++;
		}
	...
	private WaiterAgent findWaiterWithLeastCustomers() {
	...
	private class myCustomer {
		...
		myCustomer(CustomerAgent customer, int xHome, int yHome) {
