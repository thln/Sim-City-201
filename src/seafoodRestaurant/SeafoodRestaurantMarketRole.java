...
public class SeafoodRestaurantMarketRole extends Agent implements SeafoodRestaurantMarket
{
	/***** DATA *****/
	...
	public SeafoodRestaurantMarketRole(String name, SeafoodRestaurantCookRole c, SeafoodRestaurantCashierRole ca)
	{
		super();
		this.name = name;
