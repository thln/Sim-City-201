...
public class ChineseRestaurantV22BTests extends TestCase
{
	...
	//AmericanRestaurantCashierRole americanRestaurantCashier;
	...
	{
		//super.setUp();
		//americanRestaurantCashier = new AmericanRestaurantCashierRole("americanRestaurantCashier");    
	...
	public void testNormativeScenarioOne()
	{
		...
		//americanRestaurantCashier.MarketCost("Steak", 20.00, market1);
		...
		//assertEquals("The AmericanRestaurantCashier should have the one market bill for Steak. It doesn't.", americanRestaurantCashier.MarketBills.get(0).foodItem, "Steak");
	...
	public void testNormativeScenarioTwo()
	{
		...
		//assertEquals("The AmericanRestaurantCashier should have the one market bill for Steak from the first Mock Market. It doesn't.", americanRestaurantCashier.MarketBills.get(0).foodItem, "Steak");
		...
		//americanRestaurantCashier.MarketCost("Chicken", 12.00, market2);
		...
		//assertEquals("The AmericanRestaurantCashier should have the one market bill for Chicken from the second Mock Market. It doesn't.", americanRestaurantCashier.MarketBills.get(1).foodItem, "Chicken");
	...
	public void testScenarioSix()
	{
		...
		//americanRestaurantCashier.MarketCost("Steak", 40.00, market1);
